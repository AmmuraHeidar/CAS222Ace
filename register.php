...
<body>
    ...
    <div id="container">
        ...
        <main>
            ...
            <p>NOTE: Tech shirts guaranteed to pre-registered participants only.</p><br>
            
            
            <h3><a href="registration/index.php" target="_self">Register Here!</a></h3><br><br>


            <h2>PACKET PICK UP</h2>
            <p>All packet pick up will occur at Why Worry Racing, 123 NW Everett, Portland OR. Packet pick up hours: Thursday 8-5, Friday 9-noon. No day of event packet pick up.</p><br>
            ...
            <p>Splash n' Dash: Kids event for participants ages 4 to 15. This is a 100 yard swim and a 50 yard dash. It is free if an adult registers for an event otherwise it is $25.</p><br>
